...
import { Contract, Operation } from '@windrunner/contract'
...
const PersonContract = new Contract('Persons', {
    ...
    addPerson: Operation.Create(PersonSchema, Type.Omit(PersonSchema, ['id'])),
    removePerson: Operation.Remove(Type.Pick(PersonSchema, ['id'])),
})
  /** ...add them with method chaining */
  .declare('listPersons', Operation.Filter(PersonSchema, Type.Pick(PersonSchema, ['surname'])))
