...
import {
    ...
    MiddlewareFunction, MiddlewareHandler,
    Relation,
    RelativeMiddleware,
    Terminalware
} from './Middleware'
...
export type Pluggable<Request, Response, Input, Output, Context extends Record<string, unknown> = Record<string, unknown>> = (this: MiddlewareStack<Request, Response, Input, Output, Context>) => void

// eslint-disable-next-line @typescript-eslint/no-explicit-any
export class MiddlewareStack<Request = unknown, Response = unknown, Input = unknown, Output = unknown, Context extends Record<string, unknown> = Record<string, unknown>> {
    ...
    resolve<I extends Input, O extends Output> (
      ...
      context: MiddlewareExecutionContext<Context>
    ): MiddlewareHandler<Request, Response, I, O> {
        ...
        return handler as unknown as MiddlewareHandler<Request, Response, I, O>
    }
